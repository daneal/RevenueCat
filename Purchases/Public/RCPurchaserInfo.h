...
/**
 Get a dictionary of purchase dates and productIDs for Non-Renewing Subscriptions and Non-Consumables.
 
 @return A Dictionary where the keys are String representations of purchase dates, and the values are String ProductIDs.
 */
@property (readonly) NSDictionary<NSString *, NSString *> * nonSubscriptionPurchasesByPurchaseDate;
